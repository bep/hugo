...
var (
	_ resource.Resource = (*ResourceLazyInit)(nil)
	_ PathInfoProvder   = (*ResourceLazyInit)(nil)
)

type PathInfoProvder interface {
	PathInfo() *paths.Path
}

// NewResourceLazyInit creates a new ResourceLazyInit.
func NewResourceLazyInit(path *paths.Path, openContent resource.OpenReadSeekCloser) *ResourceLazyInit {
	return &ResourceLazyInit{
		Path:                 path,
		OpenContent:          openContent,
		resourceLazyInitInit: &resourceLazyInitInit{},
	}
}
...
type ResourceLazyInit struct {
	...
	*resourceLazyInitInit
}

type resourceLazyInitInit struct {
...
// Clone clones the  *ResourceLazyInit returning an uninitialized Resource.
func (r *ResourceLazyInit) Clone() *ResourceLazyInit {
	return NewResourceLazyInit(r.Path, r.OpenContent)
}

func (r *ResourceLazyInit) PathInfo() *paths.Path {
	return r.Path
}
