...
func (c *serverCommand) serve() error {
	...
	var (
		errTempl     *tplimplv2.TemplInfo
		templHandler *tplimplv2.TemplateStore
	)
	getErrorTemplateAndHandler := func(h *hugolib.HugoSites) (*tplimplv2.TemplInfo, *tplimplv2.TemplateStore) {
		if h == nil {
