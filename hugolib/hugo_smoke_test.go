...
Title: P1
Content: <p>Some <strong>content</strong>.</p>
...
ReadingTime: 1|
	...
	b.AssertFileContent("public/p1/index.json", `JSON Content: <p>Some <strong>content</strong>.</p>`)
	b.AssertFileContent("public/p1/index.csv", `CSV Content: <p>Some <strong>content</strong>.</p>`)
