...
// TODO1 use this
func (m *pageMap) MustContentNode(traits any, elem ...string) *contentNode {
...
func (m *pageMap) NewContentNode(traits any, elem ...string) (*contentNode, error) {
...
func (m *pageMap) AssemblePages(changeTracker *whatChanged) error {
	...
	if isRebuild {
		m.WalkTaxonomyTerms(func(s string, b *contentBranchNode) bool {
			b.refs = make(map[any]ordinalWeight)
			return false
		})
	}
