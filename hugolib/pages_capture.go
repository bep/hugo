...
func (c *pagesCollector) collectDir(dirPath *paths.Path, partial bool, inFilter func(fim hugofs.FileMetaDirEntry) bool) error {
	var dpath string
	if dirPath != nil {
...
func (c *pagesCollector) collectDirDir(rootDir hugofs.FileMetaDirEntry, dpath string, partial bool, inFilter func(fim hugofs.FileMetaDirEntry) bool) error {
	...
	handleDir := func(
		...
		dir hugofs.FileMetaDirEntry,
		path string,
		readdir []hugofs.FileMetaDirEntry) error {
	...
	wfn := func(path string, info hugofs.FileMetaDirEntry, err error) error {
		if err != nil {
			return err
		}
